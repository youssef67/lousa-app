...
const { runDeleteUser } = useSessionRepository()
...
async function onLoginClick() {
  try {
    ...
    updateIsOpen(false)
    pushHome()
    toast.showSuccess('Votre compte a été supprimé avec succès')
  }
}
...
<template>
  <UModal :model-value="isOpen" @update:model-value="updateIsOpen">
    <div class="p-4">
      <div class="flex">
        <div>
          <h2 class="mx-auto font-bold text-3xl mb-4">Suppression de votre compte</h2>
